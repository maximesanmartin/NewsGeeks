<html>
<head> 
	<title><?php if ( is_404() ) : ?> <?php bloginfo('name') ?> - <?php _e('Page non trouvée') ?><?php elseif ( is_home() ) : ?> <?php bloginfo('name') ?> - <?php bloginfo('description') ?><?php else : ?><?php wp_title() ?><?php endif ?></title>
